  ...
  <header class="app-header">
    <div class="top-bar">
      ...
      <div class="global-stats">
        ...
        <span class="stat-badge">Objectif: {{ trackerStore.objectifs.faits }}/{{ trackerStore.objectifs.total }}</span>
      </div>
    ...
    <nav class="main-nav">
      ...
      <router-link to="/config-activites">Types d'activités</router-link>
